...
*/
var singleActivity = Backbone.Model.extend({
...
var ActivitiesCollection = Backbone.Collection.extend({
	...
	model: _singleActivityModel2.default,
...
var Router = Backbone.Router.extend({
	...
	noCopy: function noCopy() {
		$("#copy").html("");
	},

	firstActivityMessage: function firstActivityMessage() {
		$("#copy").html("firstActivityMessage");
	},

	secondActivityMessage: function secondActivityMessage() {
		$("#copy").html("secondActivityMessage");
	},

	thirdActivityMessage: function thirdActivityMessage() {
...
var _singleActivityView = __webpack_require__(5);

var _singleActivityView2 = _interopRequireDefault(_singleActivityView);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var allActivitiesView = Backbone.View.extend({
	...
	addActivity: function addActivity(activity) {
		var activityView = new _singleActivityView2.default({ model: activity });
    ...
    */
exports.default = allActivitiesView;
...
*/
var singleActivityView = Backbone.View.extend({
...
exports.default = singleActivityView;
...
var _allActivitiesView = __webpack_require__(4);
 ...
 */
	user.fetch({
		success: function success(user) {
			var userLocationData = JSON.stringify(user.attributes);
			aLocationsObj.push({
 ...
 */
	var allActivities = new _allActivities2.default();
	var allChildrenActivities = new _childrenActivities2.default();

	var activityGroupView = new _allActivitiesView2.default({ collection: allActivities });
	var dropdownGroupView = new _allDropdownView2.default({ collection: allActivities });
	var childrenGroupView = new _allActivitiesView2.default({ collection: allChildrenActivities });
 ...
 */
	var activityRouter = new _router2.default();
...
(function(factory) {
  ...
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(7), __webpack_require__(6), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
var allDropdownView = Backbone.View.extend({
